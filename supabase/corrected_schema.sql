...
-- Create bucket policy for public access (run in Storage section of Supabase)
-- INSERT INTO storage.buckets (id, name, public) VALUES ('roast-me-ai', 'roast-me-ai', true);