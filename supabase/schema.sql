-- Roast Me Characters Database Schema
-- For Supabase PostgreSQL

-- Enable UUID extension (if not already enabled)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Image uploads table with prefix
...
-- 3D characters table with prefix
...
-- Character shares table with prefix
