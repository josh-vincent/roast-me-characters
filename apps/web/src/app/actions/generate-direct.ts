...
export async function generateDirectly(formData: FormData) {
  try {
    ...
    // Perform real AI analysis of the image
...
async function generateCharacterImageInBackground({
  ...
  try {
    ...
    // Transform features to match expected interface
    ...
    console.log('Direct character image generated successfully:', generatedImageUrls);
