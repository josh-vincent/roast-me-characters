      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-6 text-white">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-bold">🎉 Great roasts!</h2>
            <button
              onClick={onClose}
          ...
          <p className="text-white/90">
            You've used your 3 free roast characters! Create an account to get 10 more credits and keep the fun going.
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700">Get 10 bonus credits (worth $3)</span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700">Save your roast history</span>
            </div>
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  Continue with Google - Get 10 Free Credits!
                </>
              )}
            </button>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-600 mb-3">
              Or get more credits without signing up
            </p>
            <a
              href="/credits"
